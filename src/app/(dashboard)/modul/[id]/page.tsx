          ...
          fetch(`https://roynaldkalele.com/wp-json/wp/v2/traning/${trainingId}`)
            ...
            .then((trainingData) => {
              ...
              Promise.all(
                ...
                const currentIndex = modulDetails.findIndex(
                  (m: Modul) => m.id === data.id
                );
  ...
  async function submitTrainingResult({
    ...
    try {
      ...
      const res = await fetch(
        "https://roynaldkalele.com/wp-json/training-results/v1/submit",
        {
          method: "POST",
          headers: {
        ...
        {step === 1 && (
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Pelajari materi modul dengan seksama sebelum melanjutkan ke
                evaluasi
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {modul.acf?.materi_ppt || modul.acf?.video_materi ? (
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  {/* VIDEO hanya muncul jika ada */}
                  {modul.acf?.video_materi && (
                    <iframe
                      className="w-full h-[400px] mt-10"
                      src={modul.acf?.video_materi.replace(
                        "watch?v=",
                        "embed/"
                      )}
                      title="YouTube video"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-slate-700 leading-relaxed">
                        {modul.acf?.deskripsi ||
                          "Tidak ada materi modul yang tersedia."}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {!showResults && totalQuestions !== 0 && (
                <div className="space-y-2">
                  <div className="flex justify-between text-sm text-muted-foreground">
                    <span>
                      Progress: {answeredQuestions}/{totalQuestions} pertanyaan
                    </span>
                    ...
                    {soal?.soal_evaluasi_modul?.map((q, i) => (
                      <Card
                        ...
                        className={`border-2 transition-all ${
                          showResults && quizAnswers[i] === q.kunci_jawaban
                    ...
                    {totalQuestions === 0 && (
                      <>
                        ...
                        <p className="text-muted-foreground mb-4 text-center">
                          Tidak ada evaluasi untuk modul ini.
                        </p>
                      </>
                    )}
                    {!showResults ? (
                      <div className="flex gap-3">
                        ...
                        <Button
                          onClick={
                            totalQuestions === 0 ? goToNextModule : checkScore
                          }
          ...
          <Card className="shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                Anda telah menyelesaikan semua modul dalam training ini dengan
                baik. Lanjutkan perjalanan pembelajaran Anda dengan training
                lainnya.
              </p>
